...
add('Versão consolidada no index',index.count('?v=6466')>=10,index.count('?v=6466'))
add('Runtime consolidado',"window.OTTHI_GAME_VERSION = 646;" in app and "const APP_VERSION = 646;" in app)
add('Service Worker consolidado',"const CACHE = `otthi-v6466-${REVISION}`" in sw and "646.6-authenticated-gameplay-open" in sw)
